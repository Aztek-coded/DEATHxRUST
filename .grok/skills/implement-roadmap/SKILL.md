...
description: >-
  ...
  .grok/roadmaps/ or .claude/roadmaps/, or run IMPLEMENT against a planning
  document.
---
...
4. Follow `.grok/rules/` for Poise patterns, embeds/colors, errors, and data access.
...
Check in order when the user gives only a feature name:

1. `.grok/roadmaps/`
2. `.cursor/roadmaps/`
3. `.claude/roadmaps/` (historical Claude Code roadmaps)
