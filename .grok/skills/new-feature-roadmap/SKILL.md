...
description: >-
  ...
  .grok/roadmaps/ after confirming required context (or running intake). Use
...
3. **Guidelines** — align with `.grok/rules/` (project-overview, rust-discord-bot, command-development, data-management).
...
9. **Write output** — create `.grok/roadmaps/<feature-slug>-roadmap.md`
